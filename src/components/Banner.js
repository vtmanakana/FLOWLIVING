                    ...
                    <div className="row">
                        <div className="col-lg-6 mx-auto">
                            <div className="banner-area text-center pt-4 pb-4">
                                <p>We built an intelligent adtech platform that’s revolutionising human connection in a digital world. 
                                    Our mission is to empower big brands, agencies, portals and network businesses to unlock more revenue and access high-intent audiences.</p>
                                <h2 className="mt-2 mb-4 banner-title"><strong>Hello, we’re Flow</strong> </h2>
