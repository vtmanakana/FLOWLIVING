...
//     // useEffect(() => {
//     //     // Fetch agent data from the provided endpoint
//     //     fetch('https://flow-living-staging.s3.eu-west-1.amazonaws.com/public/assessment/agents.json')
...
//     agentData = async () => {
//         try {
//           const response = await fetch('https://flow-living-staging.s3.eu-west-1.amazonaws.com/public/assessment/agents.json');
...
//                                         <span>{agentData ? agentData.name : 'Agent name'}</span>
//                                     </div>
